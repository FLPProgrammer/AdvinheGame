...
import LettersUsed, { LetterUsedProps } from './components/LettersUsed/lettersUsed'
...
export default function App() {
  ...
  return (
    <div className={styles.container}>
      <main>
        <Header current={lettersUsed.length} max={(challenge?.word.length ?? 0) + ATTEMPTS_MARGIN} onRestart={handleRestartGame} />

        <Tip tip={challenge?.tip || 'Dica não disponível'} />
